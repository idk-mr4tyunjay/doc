...
function Footer() {
  return (
    <div
      ...
      className="w-full h-screen bg-zinc-100 rounded-t-3xl text-zinc-900 px-16 py-24 flex "
    >
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading font-Founders_semibold ">
          <h1 className="text-[7vw] font-semibold uppercase leading-[6vw] tracking-tighter">
            Eye-
          </h1>
          <h1 className="text-[7vw] font-semibold uppercase leading-[6vw] tracking-tighter">
            Opening
      ...
      <div className="w-1/2 h-full ">
        ...
        <h1 className="text-xl px-2 mb-3 text-zinc-700 font-Neue_Montreal">
          S:
        </h1>
        ...
        <h1 className="text-xl px-2 mb-3 text-zinc-700 mt-12 font-Neue_Montreal">
          M:
        </h1>
        <div className="content flex flex-col text-base text-zinc-600  capitalize underline underline-offset-4 px-2 font-Neue_Montreal ">
          {[
