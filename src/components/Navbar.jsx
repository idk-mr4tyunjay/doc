...
function Navbar() {
  return (
    <NavbarWrapper>
      <div className="fixed  z-[999] w-full  px-16 py-6 flex flex-row items-center justify-between backdrop-blur-sm ">
        <div className="logo text-zinc-900">
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
        ...
        <div className="links flex flex-row gap-10 font-Neue_Montreal_medium ">
          {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map(
            (item, index) => (
              <a
                key={index}
                className={`text-base ${index === 4 && "ml-44"} text-zinc-900`}
              >
                {item}
              </a>
            )
